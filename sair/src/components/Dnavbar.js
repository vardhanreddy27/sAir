...
<div className="col-9">
<div className="input-group input-groups mb-3 mynavd">
...
<div className="col-1"> 
<AiOutlineShoppingCart  className="cart2" size={30}/>
<div className="dropdown">
  <button className="dropbtn"><CgProfile className="profileicon" /></button>
